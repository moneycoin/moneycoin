...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MoneyCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"moneycointools.com", "dnsseed.moneycointools.com"},
    {"moneycoinpool.org", "dnsseed.moneycoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"moneycointools.com", "testnet-seed.moneycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MoneyCoin is probably already running."), addrBind.ToString().c_str());
        else
